...
class SwinUNETR(nn.Module):
    ...
    def __init__(
        ...
        self.out0 = UnetOutBlock(spatial_dims=spatial_dims, in_channels=feature_size, out_channels=out_channels)
        self.out1 = UnetOutBlock(spatial_dims=spatial_dims, in_channels=feature_size*2, out_channels=out_channels)
        self.out2 = UnetOutBlock(spatial_dims=spatial_dims, in_channels=feature_size*4, out_channels=out_channels)
        self.out3 = UnetOutBlock(spatial_dims=spatial_dims, in_channels=feature_size*8, out_channels=out_channels)
    ...
    def forward(self, x_in,clinical):
        ...
        return [logits,res0,res1,res2,res3]