...
class D2_My_pl_trainer(nnUNetTrainer):
    ...
    def on_train_start(self):
        ...
        self.trainer = pl.Trainer(
            ...
            ,accelerator="gpu"
            # ,devices=2
            ,strategy="deepspeed_stage_1"#"deepspeed_stage_3_offload"
            ,precision="16-mixed" #experiment.get_parameter("precision"), 
    ...
    def get_training_transforms(patch_size: Union[np.ndarray, Tuple[int]],
        ...
        #                                                       output_key='target'))
        # tr_transforms.append(NumpyToTensor(['data_a','data_b', 'target'], 'float'))
    ...
    def get_validation_transforms(deep_supervision_scales: Union[List, Tuple],
        ...
        # val_transforms.append(NumpyToTensor(['data_a','data_b', 'target'], 'float'))
