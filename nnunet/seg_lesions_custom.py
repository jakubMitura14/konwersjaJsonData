...
#CUDA_VISIBLE_DEVICES=0 my_proj_name="seg lesions 2" tag="l4b 15,8,25])/25 old "  my_proj_desc=" only focal loss weights as in tag added additional (like old) mask" nnUNetv2_train 101 3d_fullres 0 
