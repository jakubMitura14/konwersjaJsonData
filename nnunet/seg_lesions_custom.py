...
#CUDA_VISIBLE_DEVICES=0 my_proj_name="seg lesions 2" tag="l4d on sum no mask"  my_proj_desc="taken loss from picai with no masking" nnUNetv2_train 101 3d_fullres 0 
