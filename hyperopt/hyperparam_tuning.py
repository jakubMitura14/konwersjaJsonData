...
experiment_name="custom_aug_loss_b"#bias_norm
...
def setup_pseudo_lesion_adder_and_loss(trial):
    ...
    os.environ['n_lesions'] = str(trial.suggest_int("n_lesions", 2,9))
    os.environ['k_lesions'] = str(trial.suggest_int("k_lesions", 0,1000))
